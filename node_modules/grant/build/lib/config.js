...
var format = {
  ...
  custom_params: function custom_params(provider) {
    ...
    var params = (provider.custom_parameters || []).filter(function (key) {
      return !reserved.includes(key) && key !== provider.name;
    }).reduce(function (params, key) {
      return params[key] = provider[key], params;
  ...
  overrides: function overrides(provider) {
    ...
    var keys = Object.keys(provider).filter(function (key) {
      return !reserved.includes(key) && !custom_parameters.includes(key) && typeof provider[key] === 'object';
    });

    var overrides = keys.reduce(function (all, key) {
